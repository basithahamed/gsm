...
margin-top:100px;
// img{
//     box-shadow: 173px -93px 400px -32px rgba(0,0,0,0.7);
//     -webkit-box-shadow: 173px -93px 400px -32px rgba(0,0,0,0.7);
//     -moz-box-shadow: 173px -93px 400px -32px rgba(0,0,0,0.7);
// }
`
